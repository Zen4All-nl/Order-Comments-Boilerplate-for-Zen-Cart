...
// Split Page
          ...
          switch ($action) {
            ...
            case 'del' :
              ...
              $contents = array('form' => zen_draw_form('comments', FILENAME_ORDER_COMMENT_BOILERPLATE, 'page=' . $_GET['page'] . '&action=deleteconfirm') . zen_draw_hidden_field('bID', $ocInfo->comment_id));
